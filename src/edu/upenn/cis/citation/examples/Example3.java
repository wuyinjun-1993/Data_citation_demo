...
//		load_view_and_citations();
	...
	public static void load_view_and_citations(Connection c, PreparedStatement pst) throws ClassNotFoundException, SQLException
	{
		...
		String view_file = init.configProp.getProperty("example3.views");
		
		String citation_query_file = init.configProp.getProperty("example3.citation_query");
		
		String connection_file = init.configProp.getProperty("example3.connection");
