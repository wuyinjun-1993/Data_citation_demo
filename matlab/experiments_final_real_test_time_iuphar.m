file1 = 'final_real_test_full_iuphar_tuple_agg_union.csv';

file2 = 'final_real_test_full_iuphar_semi_schema_agg_union.csv';

file3 = 'final_real_test_full_iuphar_schema.csv';
...
writetable(T,'exp4/final_real_test_IUPHAR.csv','Delimiter',',', 'WriteVariableNames',false);
