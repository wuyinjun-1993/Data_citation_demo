...
public class citation_view_vector_backup {
...
//	public String head_var_string = new String();
	...
	public citation_view_vector_backup()
	{
	...
	public citation_view_vector_backup(Vector<citation_view> vec){
...
//				insert_sort(index_vec, vec.get(i).toString());
	...
	public citation_view_vector_backup merge(citation_view c)
	{
...
//			vec_new.add(c);
		...
		citation_view_vector_backup c_v = new citation_view_vector_backup(vec_new, index_new, table_names_new);
...
//	}
	...
	public citation_view_vector_backup(Vector<citation_view> vec, Vector<String> index_vec, HashSet<String> table_names){
...
//		this.view_strs = tuple_cores;
	...
	public citation_view_vector_backup(citation_view c){
	...
	public static citation_view_vector_backup merge(citation_view_vector_backup vec, citation_view c)
	{
...
//			return merge_vector(new citation_view_vector(c), vec);
	...
	public static citation_view_vector_backup merge(citation_view_vector_backup vec, citation_view_vector_backup c)
	{
		return vec.merge(c);
	}
	
	public citation_view_vector_backup merge(citation_view_vector_backup c)
	{
		citation_view_vector_backup updated_covering_set = this.clone();
		
		citation_view_vector_backup insert_covering_set = c.clone();
...
//	}
	...
	public citation_view_vector_backup clone()
	{
		citation_view_vector_backup c_v = new citation_view_vector_backup();
	...
	{
		citation_view_vector_backup c_vec = (citation_view_vector_backup) o;
