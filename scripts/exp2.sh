...
java -jar ../target/process_text.jar ./ true false final_stress_test_group_full 3 3 

java -jar ../target/process_text.jar ./ false false final_stress_test_group_min 3 10
