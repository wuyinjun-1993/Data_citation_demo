...
class Query {
  ...
  String  name = null; // query name
  Subgoal head = null; // the head is also a subgoal
  Vector  body = null; // a set of subgoals
   ...
   * Constructor
   */
  Query(String name, Subgoal head, Vector body) {
    this.name = name;
    this.head = head;
    this.body = body;
  }
  
  Query(String name, Subgoal head, Vector body, Vector lambda_term) {
	    this.name = name;
	    this.head = head;
	    this.body = body;
