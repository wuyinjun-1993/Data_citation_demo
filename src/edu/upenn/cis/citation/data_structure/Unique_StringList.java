...
public class Unique_StringList {
...
//	    }
	...
	public static void main(String[] args)
	{
		...
		Unique_StringList s_list = new Unique_StringList(len);
		...
		for(int i = 0; i<len; i++)
		{
			...
			arr_str[i] = String.valueOf(r.nextInt(len/2));
...
//			System.out.println(arr_str[i]);
		...
		{
			System.out.println(s_list.list[i]);
		}
	}
	
	public Unique_StringList(String [] str_list)
	{
	...
	public Unique_StringList(int len)
	{
		list = new String[len];
	}
	
	public Unique_StringList()
	{
		size = 0;
	}
...
//		int pos = Arrays.binarySearch(list, insert, s_compare);
		...
		if(list[pos].hashCode() == insert.hashCode())
			return;
