...
for i=1:NumStacksPerGroup
    ...
    groupDrawPos = 2*i - 3 + groupLabels';
    
    h(i,:) = bar(groupLabels, Y, 'stacked');
    set(h(i,:),'BarWidth',0.35);
    set(h(i,:),'XData',groupDrawPos);
    
    if i == 2
        set(h(i,1),'facecolor','y','edgecolor','k'); 
        set(h(i,2),'facecolor','b','edgecolor','k'); 
    else
        set(h(i,1),'facecolor','c','edgecolor','k'); 
        set(h(i,2),'facecolor','m','edgecolor','k');
    end
%     
end
% hold off;
